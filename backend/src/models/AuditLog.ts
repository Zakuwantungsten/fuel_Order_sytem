...
const AUDIT_ACTIONS: AuditAction[] = [
  ...
  'LOGIN_BLOCKED', 'ELEVATED_RISK_LOGIN',
  // Data access
  'VIEW_SENSITIVE_DATA', 'EXPORT',
  // Workflow
  'APPROVE', 'REJECT',
  // Session management
  'FORCE_LOGOUT', 'CONCURRENT_SESSION_KILL', 'SESSION_TERMINATED', 'SESSION_REVOKED',
  // Account actions
  'ACCOUNT_DEACTIVATED', 'ACCOUNT_ACTIVATED', 'ACCOUNT_BANNED', 'ACCOUNT_UNBANNED',
  // System
...
const ACTION_BASE_RISK: Partial<Record<AuditAction, number>> = {
  ...
  FORCE_LOGOUT: 65, CONCURRENT_SESSION_KILL: 30, SESSION_TERMINATED: 60, SESSION_REVOKED: 15,
  ACCOUNT_DEACTIVATED: 60, ACCOUNT_ACTIVATED: 40, ACCOUNT_BANNED: 80, ACCOUNT_UNBANNED: 45,
