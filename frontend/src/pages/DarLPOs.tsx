    ...
    <div className="p-4 lg:p-6 space-y-5 min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {viewMode === 'workbook' && (
        <div className="flex-1 min-h-[600px]">
          <DarLPOWorkbook onBack={() => setViewMode('list')} />
        </div>
      )}
        ...
        <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex flex-wrap gap-3 items-center">
          <div className="relative flex-1 min-w-[180px]">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-green-500 focus:border-transparent"
            />
          </div>
          <input
            type="date"
            ...
            className="px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-green-500 focus:border-transparent"
          />
        ...
        {isLoading ? (
          ...
          <div className="py-16 text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400 font-medium">
              {hasFilters ? 'No LPOs match your filters' : 'No Dar LPOs yet'}
            </p>
            {!hasFilters && canWrite && (
              <button
                onClick={() => setShowForm(true)}
