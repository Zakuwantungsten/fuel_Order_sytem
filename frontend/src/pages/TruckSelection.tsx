            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {filteredTrucks.map((truck) => (
                <button
                  ...
                  className="group relative bg-gradient-to-br from-indigo-50 to-blue-50 hover:from-indigo-100 hover:to-blue-100 border-2 border-indigo-200 hover:border-indigo-400 rounded-xl p-6 transition-all duration-200 hover:shadow-lg"
                >
