...
export const ROLE_PERMISSIONS: Record<UserRole, RolePermissions> = {
  super_admin: {
    ...
    permissions: [
      ...
      { resource: RESOURCES.FLEET_TRACKING, actions: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.UPDATE, ACTIONS.DELETE, ACTIONS.EXPORT, ACTIONS.MANAGE] },
      { resource: RESOURCES.CHECKPOINTS, actions: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.UPDATE, ACTIONS.DELETE, ACTIONS.MANAGE] },
      { resource: RESOURCES.VISA_OVERSTAYS, actions: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.UPDATE, ACTIONS.DELETE, ACTIONS.MANAGE, ACTIONS.EXPORT] },
      ...
      { resource: RESOURCES.DATABASE_MONITOR, actions: [ACTIONS.READ, ACTIONS.MANAGE] },
      { resource: RESOURCES.TRASH, actions: [ACTIONS.READ, ACTIONS.RESTORE, ACTIONS.PERMANENT_DELETE] },
  ...
  admin: {
    ...
    permissions: [
      ...
      { resource: RESOURCES.LPOS, actions: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.UPDATE, ACTIONS.DELETE, ACTIONS.APPROVE, ACTIONS.EXPORT] },
      { resource: RESOURCES.FUEL_RECORDS, actions: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.UPDATE, ACTIONS.DELETE, ACTIONS.EXPORT] },
      { resource: RESOURCES.FLEET_TRACKING, actions: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.UPDATE, ACTIONS.DELETE, ACTIONS.EXPORT] },
      { resource: RESOURCES.CHECKPOINTS, actions: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.UPDATE, ACTIONS.DELETE] },
      { resource: RESOURCES.VISA_OVERSTAYS, actions: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.UPDATE, ACTIONS.DELETE, ACTIONS.EXPORT] },
  ...
  super_manager: {
    role: 'super_manager',
    description: 'Super manager with access to all stations LPO data',
    permissions: [
      { resource: RESOURCES.DASHBOARD, actions: [ACTIONS.READ] },
      { resource: RESOURCES.DELIVERY_ORDERS, actions: [ACTIONS.READ, ACTIONS.EXPORT] },
      { resource: RESOURCES.LPOS, actions: [ACTIONS.READ, ACTIONS.EXPORT] },
      { resource: RESOURCES.FUEL_RECORDS, actions: [ACTIONS.READ, ACTIONS.EXPORT] },
  ...
  clerk: {
    role: 'clerk',
    description: 'Data entry and passport / visa / overstay operations',
    permissions: [
      { resource: RESOURCES.DASHBOARD, actions: [ACTIONS.READ] },
      ...
      { resource: RESOURCES.VISA_OVERSTAYS, actions: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.UPDATE] },
  ...
  fuel_order_maker: {
    ...
    permissions: [
      ...
      { resource: RESOURCES.LPOS, actions: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.UPDATE, ACTIONS.APPROVE, ACTIONS.EXPORT] },
      { resource: RESOURCES.FUEL_RECORDS, actions: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.UPDATE, ACTIONS.EXPORT] },
      { resource: RESOURCES.FLEET_TRACKING, actions: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.EXPORT] },
      { resource: RESOURCES.CHECKPOINTS, actions: [ACTIONS.READ, ACTIONS.CREATE, ACTIONS.UPDATE] },
      { resource: RESOURCES.REPORTS, actions: [ACTIONS.READ, ACTIONS.EXPORT] },
    ],
  },
  boss: {
