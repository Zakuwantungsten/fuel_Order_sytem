...
export function PaymentManager({ user }: { user: any }) {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-gray-900 mb-2">Payment & Order Management</h1>
        <p className="text-gray-600">Manage fuel orders and handle alternative payments</p>
      </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-2xl text-gray-900 mt-1">{stats.active}</div>
            </div>
